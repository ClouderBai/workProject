/*
 * @Author: LiuJunTing 
 * @Date: 2018-03-12 16:34:26 
 * @Last Modified by: LiuJunTing
 * @Last Modified time: 2018-03-20 17:00:22
 */
...
<template>
    <div>
        <el-table v-loading="loading" :data="data" row-key="key" :type="type" style="cursor:pointer;" highlight-current-row @row-click="rowClick" @selection-change="checkedChange" border stripe :height="height">
